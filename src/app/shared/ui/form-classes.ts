/** Class strings taken verbatim from the Stitch forms, shared so templates stay small. */
export const INPUT =
  'w-full px-3 py-2 text-body-md font-body-md bg-surface-container-lowest border border-outline-variant/40 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary focus:outline-none transition-all';
